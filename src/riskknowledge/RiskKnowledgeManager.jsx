...
export default function RiskKnowledgeManager({ onBack, currentUser }) {
  ...
  return (
    <div style={{ maxWidth: 1000, margin: "0 auto", padding: 24 }}>
      ...
      {filtered.map((rec) => (
        <div key={rec.id} style={{ ...styles.card, width: "auto", marginBottom: 8, border: mergeSourceId === rec.id ? `2px solid ${THEME.teal}` : undefined }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 8, flexWrap: "wrap" }}>
            <div style={{ flex: 1, minWidth: 200, cursor: "pointer" }} onClick={() => openEdit(rec)}>
